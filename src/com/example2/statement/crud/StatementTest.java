package com.example2.statement.crud;
...
public class StatementTest {
	...
	public void testLogin() {
		...
		String sql = "SELECT user,password FROM user_table WHERE user='1' OR password = '1' OR '1' = '1'";
		User users = get(sql, User.class);
		if (users != null) {
...
//		}
	...
	public <T> T get(String sql, Class<T> clazz) {
		...
		try {
			// 1.加载配置文件
			InputStream is = StatementTest.class.getClassLoader().getResourceAsStream("info.properties");
